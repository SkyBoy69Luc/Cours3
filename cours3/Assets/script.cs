...
public class script : MonoBehaviour {
    ...
    void Start () {
        movementContactFilter = buildContactFilter(LayerMask.LayerToName(gameObject.layer));
    ...
    private void Movement(Vector2 move)
    {
        ...
        if (distance > minMoveDistance)
        {
            ...
            {
                print(hitBufferList[i].ToString());
    ...
    private ContactFilter2D buildContactFilter(string LayerName) {
